                    ...
                    if(cust.getCustName().equalsIgnoreCase(removeName)){
                        ...
                        while(!"Y".equals(YN) || !"N".equals(YN)){
                            ...
                            if(YN.equalsIgnoreCase("Y")){
                                if(cust instanceof PayingCustomer){ //issue with this if() else()
                                    for(int d=0;d<rmvCustomer.size();d++){
                                        for(int a=0;a<cust.getAssociateCustomer().size();a++){
                                            if(rmvCustomer.get(a).getCustName().equalsIgnoreCase(cust.getAssociateCustomer().get(d).getCustName())){
                                                ITR.remove();
                                            }
                                        }
                                    }
